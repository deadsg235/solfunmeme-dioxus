...
pub fn copy_text_to_clipboard(text: String, snippet_id: String, mut copied_snippets: Signal<HashSet<String>>) {
    wasm_bindgen_futures::spawn_local(async move {
        if let Some(window) = window() {
...
pub fn copy_all_snippets_combined(snippets: Vec<CodeSnippet>, copied_snippets: Signal<HashSet<String>>) {
    ...
    copy_text_to_clipboard(combined, "all_snippets".to_string(), copied_snippets);
}
// ```
pub fn create_copy_handler(
    ...
    move |text: String, snippet_id: String| {
        ...
        {
            copy_to_clipboard_web(text, snippet_id, copied_snippets.clone());
        }
        
        #[cfg(not(target_arch = "wasm32"))]
        {
//            copy_to_clipboard_desktop(text, snippet_id, clipboard.clone(), copied_snippets.clone());
        }
    }
}
